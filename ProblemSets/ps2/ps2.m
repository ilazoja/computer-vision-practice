...
% 
% % Compute disparity
% D_L = disparity_ssd(noisy_L, R, 50, true, 150);
% D_R = disparity_ssd(R, noisy_L, 50, true, 150);
% 
% % Save output images (D_L as output/ps2-1-a-1.png and D_R as output/ps2-1-a-2.png)
% % Note: They may need to be scaled/shifted before saving to show results properly
% f = figure();
...
% 
% % Compute disparity
% D_L = disparity_ssd(brighter_L, R, 100, true, 100);
% D_R = disparity_ssd(R, brighter_L, 100, true, 100);
% 
% % Save output images (D_L as output/ps2-1-a-1.png and D_R as output/ps2-1-a-2.png)
% % Note: They may need to be scaled/shifted before saving to show results properly
% f = figure();
...
% 
% % Compute disparity
% D_L = disparity_ncorr(noisy_L, R, 100, true, 100);
% D_R = disparity_ncorr(R, noisy_L, 100, true, 100);
% 
% % Save output images (D_L as output/ps2-1-a-1.png and D_R as output/ps2-1-a-2.png)
% % Note: They may need to be scaled/shifted before saving to show results properly
% f = figure();
...
% 
% % Compute disparity
% D_L = disparity_ncorr(brighter_L, R, 100, true, 100);
% D_R = disparity_ncorr(R, brighter_L, 100, true, 100);
% 
% % Save output images (D_L as output/ps2-1-a-1.png and D_R as output/ps2-1-a-2.png)
% % Note: They may need to be scaled/shifted before saving to show results properly
% f = figure();
...
% Compute disparity
D_L = disparity_ncorr(L, R, 10, true, -size(L, 2));
D_R = disparity_ncorr(R, L, 10, true, size(L, 2));
